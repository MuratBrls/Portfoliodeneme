      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            type="text"
            required
            className="border border-neutral-300 bg-white px-4 py-3 text-sm text-neutral-900 outline-none transition focus:border-neutral-600 focus:ring-1 focus:ring-neutral-600 dark:border-white/10 dark:bg-black dark:text-white dark:focus:border-white"
          />
        </div>
