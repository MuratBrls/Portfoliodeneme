export function Footer() {
  return (
    <footer className="border-t border-neutral-200 bg-neutral-50 py-6 text-xs uppercase tracking-[0.2em] text-neutral-700 dark:border-white/10 dark:bg-black dark:text-white">
