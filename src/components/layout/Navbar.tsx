    ...
    <header className="sticky top-0 z-50 border-b border-neutral-200 bg-neutral-50/80 backdrop-blur-md dark:border-white/10 dark:bg-black/80">
      <nav className="mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-4 text-sm uppercase tracking-wide md:px-6">
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <Link href="/" className="text-xl font-bold tracking-tight text-neutral-900 dark:text-white transition-opacity hover:opacity-70 md:text-2xl">
            LUME
          </Link>
        </div>
        <div className="flex items-center gap-2 md:gap-6">
          {/* Desktop Navigation */}
          <div className="hidden items-center gap-6 text-xs font-medium text-neutral-800 dark:text-white md:flex">
            <Link
              href="/artists"
              className="rounded-full border border-transparent px-3 py-1.5 transition-all duration-200 hover:border-neutral-300 hover:bg-neutral-100 dark:hover:border-white/20 dark:hover:bg-white/5"
            >
              Artists
            </Link>
            <Link
